...
@Component({
  ...
  template: `
    <marker>Base Model with <code>data-groups</code></marker>
    <code-example label="Data groups Overview">
      ...
      <code-block type="html" [code]="htmlCode" language="html">
        <p>
          ...
          the <code>BaseModel</code> instance into each form UI component.
          Remember that the latter must extend from
          <code>DataInputBase</code> to take advantage of the
          <code>BaseModel</code> and must have the template variable
        ...
        <p>
          ...
          elements. This <code>data-group</code> selector will have more sense
          when we implement an instance of <code>BaseModelArray</code>.
        </p>
        <p>
      ...
      <code-block type="component" [code]="componentCode" language="typescript">
        <p>
          Here we can see the instance of the <code>BaseModel</code> initialized
          in the <code>exampleModel</code> property. It receives as parameter in
          the constructor the DTO class, which contains all the data attributes
          and validation rules.
        </p>
        <p>
          The <code>BaseModel</code> also provides us of useful methods to fill
          or clear our form UI with data.
        </p>
        <p>
      ...
      <code-block type="dto" [code]="dtoCode" language="typescript">
        <p>
          ...
          loaded inside the <code>BaseModel</code> instance.
        </p>
      </code-block>
    </code-example>
  `,
